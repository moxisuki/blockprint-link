...
public final class QrScreen extends Screen {
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        int bound = UiHooksForge.TOGGLE_KEY != null
            ? UiHooksForge.TOGGLE_KEY.getKey().getValue() : 296;
    ...
    public void render(GuiGraphics g, int mx, int my, float pt) {
        ...
        if (font != null) {
            ...
            String closeKey = UiHooksForge.TOGGLE_KEY != null
                ? UiHooksForge.TOGGLE_KEY.getTranslatedKeyMessage().getString() : "F7";
